...
<body>
    ...
    <table class="table-layout" style="margin-bottom: 20px;">
        ...
        <tr>
            ...
            <td>
                ...
                $dayName = $days[$permintaan->created_at->format('l')];
                echo $dayName . ', ' . $permintaan->created_at->format('d F Y');
                ?>
            </td>
        </tr>
        <tr>
            ...
            <td class="separator-column">:</td>
            <td><?php echo $permintaan->user->name; ?></td>
        </tr>
    </table>
    ...
    <table class="table-data">
        ...
        <tbody>
            <?php if (count($permintaan->barang_permintaan) > 0): ?>
                <?php foreach ($permintaan->barang_permintaan as $index => $item): ?>
                    <tr>
    ...
    <div class="print-info">
        Dicetak pada: <?php echo date('d/m/Y H:i:s'); ?> | Bapenda Provinsi Sumatera Selatan
    </div>

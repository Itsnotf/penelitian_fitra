...
<body>
    ...
    <table class="table-layout" style="margin-bottom: 20px;">
        <tr>
            <td class="label-column">No Pengadaan</td>
            <td class="separator-column">:</td>
            <td><?php echo $pengadaan->id; ?></td>
        </tr>
        <tr>
            <td class="label-column">Tanggal Pengadaan</td>
            <td class="separator-column">:</td>
            <td><?php echo $pengadaan->created_at->format('d/m/Y'); ?></td>
        </tr>
        <tr>
            <td class="label-column">Vendor</td>
            <td class="separator-column">:</td>
            <td><?php echo $pengadaan->vendor ? $pengadaan->vendor->nama_vendor : '-'; ?></td>
        </tr>
        <tr>
            <td class="label-column">Pengadaan Oleh</td>
            <td class="separator-column">:</td>
            <td><?php echo $pengadaan->user->name; ?></td>
        </tr>
        <tr>
            <td class="label-column">Deskripsi</td>
            <td class="separator-column">:</td>
            <td><?php echo $pengadaan->deskripsi ?? '-'; ?></td>
        </tr>
        <tr>
            <td class="label-column">Status</td>
            <td class="separator-column">:</td>
            <td><strong><?php echo ucfirst($pengadaan->status); ?></strong></td>
        </tr>
    </table>
    ...
    <table class="table-data">
        ...
        <tbody>
            <?php if(count($pengadaan->barang_pengadaan) > 0): ?>
                <?php foreach($pengadaan->barang_pengadaan as $index => $item): ?>
                    <tr>
    ...
    <table class="table-layout" style="margin-bottom: 20px;">
        <tr>
            ...
            <td class="text-right"><strong>Rp <?php echo number_format($pengadaan->total_harga ?? 0, 0, ',', '.'); ?></strong></td>
        </tr>
    </table>
